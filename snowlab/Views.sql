...
DROP VIEW tasty_bytes.harmonized.orders_v;
...
CREATE VIEW test_database.test_schema.truck_franchise     
AS 
SELECT t.*,     
f.first_name AS franchisee_first_name,
f.last_name AS franchisee_last_name 
...
---solution-2---
SELECT * FROM test_database.test_schema.truck_franchise WHERE FRANCHISEE_FIRST_NAME = 'Sara' AND FRANCHISEE_LAST_NAME = 'Nicholson';
